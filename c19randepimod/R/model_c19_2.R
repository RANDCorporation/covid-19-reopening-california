...
#'}
#'
c19model_amshi2s = function(inputs, level) {
  ...
  model$model_fn = model_function.c19model_amshi2s
  
  model$set_calibrated_stocks = set_calibrated_stocks.c19model_amshi2s
  
  model$set_initial_stocks = set_initial_stocks.c19model_amshi2s
  
  model$set_computed_params = set_computed_params.c19model_amshi2s
  
  model$verify_input_parameters = verify_input_parameters.c19model_amshi2s
  
  model$set_stocks_positions = set_stocks_positions.c19model_amshi2s
  
  model$model_name = "c19model_amshi2s"
  
  model$status = "uncalibrated"
  
  # Uniformize Inputs according to the intended level:
  
  class(model) = c("c19model_amshi2s", "c19model")
  
  model
}

# use this in a near future:
set_calibrated_stocks.c19model_amshi2s = function(model, run_id) {
...
set_initial_stocks.c19model_amshi2s = function(model, initial_exposed) {
...
set_computed_params.c19model_amshi2s = function(model) {
...
verify_input_parameters.c19model_amshi2s = function(model) {
  # verify Parametrers
...
model_function.c19model_amshi2s = function(time, stocks, params, model, run_id) {
...
set_stocks_positions.c19model_amshi2s = function(model) {
  
  # Get positions directly from the model object.
